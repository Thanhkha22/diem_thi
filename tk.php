...
if (isset($_POST['action'])) {
    ...
    if ($action == 'add') {
        ...
        if (empty($username) || empty($fullName) || empty($role)) {
            ...
            // Kiểm tra nếu mật khẩu mới có thì cập nhật mật khẩu
            if (!empty($password)) {
                // Nếu có mật khẩu mới thì không mã hóa mà lưu trực tiếp mật khẩu gốc
                ...
                $params = [
                    'username'   => $username,
                    'password'   => $password, // Lưu trực tiếp mật khẩu gốc
                    'full_name'  => $fullName,
                    'role'       => $role,
                ...
                // Nếu không cập nhật mật khẩu, chỉ cập nhật các thông tin khác
                $sql = "UPDATE tbl_nguoi_dung
                        SET username = :username,
                            full_name = :full_name,
                            role = :role,
...
<head>
    ...
    <!-- ẩn/hiện form cập nhật thông tin của tài khoản -->
    <script>
